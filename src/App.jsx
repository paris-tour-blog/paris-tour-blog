		...
		<>
			<MantineProvider>
				...
				<Routes>
					...
					<Route
						path="/CreateBlogPostMuseum"
						element={<CreateBlogPostMuseum />}
					/>
					<Route
						path="/CreateBlogPostFriperie"
						element={<CreateBlogPostFriperie />}
					/>
					<Route
						path="/CreateBlogPostResto"
						element={<CreateBlogPostRestaurant />}
					/>
					...
					<Route
						path="/EditBlogFriperies/:id"
						element={<EditBlogFriperies />}
					/>
					<Route
						path="/EditBlogRestaurant/:id"
						element={<EditBlogRestaurant />}
					/>
				</Routes>
